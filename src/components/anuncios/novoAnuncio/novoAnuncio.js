...
export function NovoAnuncio() {
    ...
    return (
      <form onSubmit={Entry}>
        <input
          ...
          placeholder="valor"
          onChange={(e) =>
            setNovoAnuncio({ ...novoAnuncio, value: e.target.value })
          }
        />
        <input
          type="text"
          ...
          onChange={(e) =>
            setNovoAnuncio({ ...novoAnuncio, description: e.target.value })
          }
        />
        <input
          type="text"
          ...
          onChange={(e) =>
            setNovoAnuncio({ ...novoAnuncio, image: e.target.value })
          }
        />
  ...
  return (
    <ContainerCadastro>
      <Header2 />
      <ContainerInputs>{imprimirInputs}</ContainerInputs>
      <FooterNovoAnuncio />
    </ContainerCadastro>
  );
}
